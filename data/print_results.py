...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # Print incorrect dog/non-dog classifications if requested
    if print_incorrect_dogs and (
        (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs']) != results_stats_dic['n_images']
    ):
        print("\nINCORRECT Dog/NOT Dog Assignments:")
        for key in results_dic:
            # Print where there is a misclassification in dog vs. non-dog
    ...
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        ...
        for key in results_dic:
            # Print where the image is classified as a dog, but the breed is incorrect
